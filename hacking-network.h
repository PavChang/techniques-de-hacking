...
#define EOL_SIZE 2
   unsigned char *ptr; 
   /*
      Cette attaque tampon est un peu différente grâce à un pointeur.
      Le pointeur va sauvegarder les données sur le stack pour écraser l'adresse de retour de la fonction handle_connection
   */
   int eol_matched = 0;
